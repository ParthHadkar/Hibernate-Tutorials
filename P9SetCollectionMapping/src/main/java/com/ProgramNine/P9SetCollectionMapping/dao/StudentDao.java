package com.ProgramNine.P9SetCollectionMapping.dao;
...
import com.ProgramNine.P9SetCollectionMapping.model.Student;

public class StudentDao {
	
	public static void addStudent(int id, int age, String name, String gender, Set<String> laptop) {
